...
from materials.views import CourseViewSet, LessonCreateAPIView, LessonListAPIView, LessonRetriveAPIView, LessonUpdateAPIView, LessonDestroyAPIView
...
urlpatterns = [
    ...
    path('view/<int:pk>/', LessonRetriveAPIView.as_view(), name='lesson_view'),
